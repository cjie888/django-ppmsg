...
MEDIA_ROOT = os.path.join(os.path.dirname(__file__), 'img')
...
DOMAIN = 'www.funshion.com'

CONNECT_US = 'dev-web-sys@funshion.com' #  tell user how to connect you

LOGIN_URL = "/accounts/login"  # must set
LOGOUT_URL = "/accounts/logout"  # must set
SITE_NAME = u'快图'
